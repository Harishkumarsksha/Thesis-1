...
\paragraph{Experimental and Computational Results of SLPB120216216 \cite{UKEMPT_AHMAD2012}}
...
% 	  \centering
% 	  \includegraphics[width=.4\linewidth]{Chap06/Figures/Batt_DisCh_Ohmic_Resistance.PNG}  
% 	%   \caption{Put your sub-caption here}
% 	  \label{fig:Batt_DisCh_Ohmic_Resistance}
% 	\end{subfigure}
% 	\begin{subfigure}{.5\textwidth}
% 	  \centering
% 	  \includegraphics[width=.4\linewidth]{Chap06/Figures/Batt_Ch_Ohmic_Resistance.PNG}  
% 	%   \caption{Put your sub-caption here}
% 	  \label{fig:Batt_Ch_Ohmic_Resistance}
% 	\end{subfigure}
% 	\begin{subfigure}{.5\textwidth}
% 	  \centering
% 	  \includegraphics[width=.4\linewidth]{Chap06/Figures/Batt_DisCh_OutPut_Voltage.PNG}  
% 	%   \caption{Put your sub-caption here}
% 	  \label{fig:Batt_DisCh_OutPut_Voltage}
% 	\end{subfigure}
% 	\begin{subfigure}{.5\textwidth}
% 	  \centering
% 	  \includegraphics[width=.4\linewidth]{Chap06/Figures/Batt_Ch_OutPut_Voltage.PNG}  
% 	%   \caption{Put your sub-caption here}
% 	  \label{fig:Batt_Ch_OutPut_Voltage}
% 	\end{subfigure}
% \end{figure}
