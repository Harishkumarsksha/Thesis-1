...
class Battery:
    ...
    @property
    def Columb_count(self):
        # print(np.random.uniform(0.0001,0.0005))
        # print(self.current*np.random.uniform(0.1,0.5) * 10 /(self.total_capacity))
        return self.state_of_charge + self.current * 10 /(self.total_capacity)
